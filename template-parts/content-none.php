...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'bussiness-lander' ); ?></h1>
	</header><!-- .page-header -->
			...
			<p><?php
				printf(
					wp_kses(
						...
						__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'bussiness-lander' ),
						array(
							'a' => array(
								'href' => array(),
							),
